...
class TestGetStringSimilarityScores:
    ...
    def test_basic_similarity(self, mock_process):
        ...
        results = similarity.get_string_similarity_scores(target, candidates, limit=3)
    ...
    def test_limit(self, mock_process):
        ...
        results = similarity.get_string_similarity_scores(target, candidates, limit=2)
...
class TestGetVectorSimilarityScores:
    ...
    def test_empty_candidates(self):
        """Test with empty candidates list."""
        mock_model = MagicMock()
        results = similarity.get_vector_similarity_scores(mock_model, "Anna", [])
        assert results == []
    ...
    def test_vector_similarity(self, mock_np):
        ...
        results = similarity.get_vector_similarity_scores(mock_model, target, candidates, limit=2)
    ...
    def test_limit_exceeds_candidates(self, mock_np):
        ...
        results = similarity.get_vector_similarity_scores(mock_model, target, candidates, limit=10)
