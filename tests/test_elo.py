...
class TestUpdateEloGeneric:
    ...
    def test_custom_k_factor(self):
        ...
        updated_large_k = elo.update_elo_generic(ratings1, "Alice", "Bob", 1.0, 0.0, k=64.0)
        updated_small_k = elo.update_elo_generic(ratings2, "Alice", "Bob", 1.0, 0.0, k=16.0)
    ...
    def test_missing_player(self):
        ...
        ratings_empty = {}
        updated_empty = elo.update_elo_generic(ratings_empty, "Alice", "Bob", 1.0, 0.0)
